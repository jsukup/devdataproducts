---
title: 'Chicago Food Inspections: Restaurant Risk Level - 2001 to Present'
...
###Data Processing
Not shown in the app are steps taken to clean the raw data set retrieved from the above URL. Steps take are as follow:
